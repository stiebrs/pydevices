...
from devices.instrument.spectrometer.ibsen.rock.rock import Spectrometer, OutputFormat, CaptureType
...
try:
	...
	print('WL calibration coeffs: {}:'.format(spec._wl_coefficients))
